...
from shop.assembly.models import AtomicPrerequisite, Blueprint, BuildPrerequisite
...
#             b_set_req = BuildPrerequisite.objects.create(blueprint_component=b, min_quantity=2, max_quantity=2)
#             b_set.blueprint_prerequisites.add(b_set_req)
#             b_set.save()
#         except:
#             self.fail('Creation of Blueprint object failed.')
#
...
#         self.table.atomic_prerequisites.add(r)
#         self.table.save()
#         br = BuildPrerequisite.objects.create(blueprint_component=self.table, min_quantity=1, max_quantity=1)
#
#         self.tableset.blueprint_prerequisites.add(br)
#         self.tableset.save()
#
#     def test(self):
#         """
...
#         self.table.atomic_prerequisites.add(r1)
#         self.table.save()
#         br = BuildPrerequisite.objects.create(blueprint_component=self.table, min_quantity=1, max_quantity=1)
#
#         self.tableset.blueprint_prerequisites.add(br)
#         self.tableset.atomic_prerequisites.add(r2)
#         self.tableset.save()
#
#     def test(self):
#         """
...
#             self.chairBlueprint.atomic_prerequisites.add(req)
...
#             BuildPrerequisite.objects.create(blueprint_component=self.tableBlueprint, min_quantity=1, max_quantity=1),
#             BuildPrerequisite.objects.create(blueprint_component=self.chairBlueprint, min_quantity=1, max_quantity=4)
#         ]
#         self.tableset.atomic_prerequisites.add(tablesetAtomicRequirement)
#         for bpReq in tablesetBlueprintRequirement:
#             self.tableset.blueprint_prerequisites.add(bpReq)
#         self.tableset.save()
#

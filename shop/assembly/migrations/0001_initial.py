    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_urls', models.ManyToManyField(related_name='blueprint_image_urls', to='shop.URL')),
                ('offset_image_urls', models.ManyToManyField(related_name='offset_blueprint_image_urls', to='shop.OffsetImageURL')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_urls', models.ManyToManyField(related_name='product_image_urls', to='shop.URL')),
                ('offset_image_urls', models.ManyToManyField(related_name='offset_product_image_urls', to='shop.OffsetImageURL')),
            ],
            options={
                'abstract': False,
            },
